			...
			<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
				...
				<div class="collapse navbar-collapse" id="navbar1">
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item">
							<a class="nav-link active" href="projects.php">Проекты</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="\kostya2003\index.php">Выйти</a>
						</li>
					</ul>
				</div>
        <div>
...
<footer class="text-muted py-1">
  <div class="container">
    <p class="float-end mb-1">
      <a href="#" style="color: black;"><i class="bi bi-arrow-90deg-up"></i>Back to top</a>
    </p>
  </div>
</footer>
</body>
